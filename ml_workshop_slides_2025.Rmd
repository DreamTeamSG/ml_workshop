...
You can find all materials for this workshop here: <https://osf.io/mnfbd/>

![QrCode](Figures/qrcode.png){width="30%"}\centering
\
...
-   Introduction
    ...
    -   1 Applications in Personality Psychology
    -   2 Predictive Modeling Mindset
    -   3 Basic Terminology
    -   4 **HANDS ON: Some Introductory Words**
...
-   Performance Evaluation 
    ...
    -   3 Resampling Strategies for Model Evaluation
    -   4 **HANDS-ON: Performance Evaluation With Resampling**
    -   5 Some Advanced Aspects on Model Evaluation
...
## 3 Resampling Strategies for Model Evaluation @bischl_resampling_2012
...
<!-- Explain Rmarkdown Code Chunks -->

```{r}
# Code check - is size big enough with shared screen?
t.test(1:3, 4:6)
```
...
```{r}
matrix(c(prediction$score(mes), res$aggregate(mes)), nrow = 2,
...
- mlr3 is written in the **R6** OOP system (<https://mlr3book.mlr-org.com/r6.html>)   
- **WARNING:** R6 objects are *NOT* copied when modified. 
- If you want to copy an mlr3 object you have to use the `$clone(deep = TRUE)` method!
...
![feierabend](Figures/feierabend.png){width="90%"}\centering
...
-   Important topics when using variable importance in practice:
    ...
    -   Some measures are more expensive to compute than others
...
-   Carefully apply IML to learn about your models inner workings
...
-   Personality Computing 
    ...
    -   DFG-funded [Personality Computing Network](https://www.personalitycomputing.net)
    -   @henninger2023
    -   @Stachl2020ML
...
[ramona.schoedel\@charlotte-fresenius-uni.de](mailto:ramona.schoedel@charlotte-fresenius-uni.de){.email}\
\
